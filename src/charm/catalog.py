...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "adaptive_t1": {
        ...
        "tier": "T1",
        "means": (
            "charm smell is a nonadaptive checklist. Research (research/LADDER_MASTER.md) "
            "shows adaptive short inspections can be arbitrarily stronger than fixed "
            "checklists of the same look-count on synthetic branch/parity habitats."
        ),
        "fix": (
